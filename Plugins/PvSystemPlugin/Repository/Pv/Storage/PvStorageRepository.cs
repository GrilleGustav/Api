...
namespace PvSystemPlugin.Repository.Pv.Storage
{
  ...
  /// </summary>
  public class PvStorageRepository : RepositoryPvBase<PvStorage>, IPvStorageRepository
  {
    ...
    public PvStorageRepository(RepositoryPvContext repositoryContext) : base(repositoryContext)
    {
