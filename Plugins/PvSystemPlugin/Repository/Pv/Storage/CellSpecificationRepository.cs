...
namespace PvSystemPlugin.Repository.Pv.Storage
{
  ...
  /// </summary>
  public class CellSpecificationRepository : RepositoryPvBase<CellSpecification>, ICellSpecificationRepository
  {
    ...
    public CellSpecificationRepository(RepositoryPvContext repositoryContext) : base(repositoryContext)
    {
