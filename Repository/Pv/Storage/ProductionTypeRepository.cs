...
namespace Repository.Pv.Storage
{
  ...
  /// </summary>
  public class ProductionTypeRepository : RepositoryBase<ProductionType>, IProductionTypeRepository
  {
    ...
    public ProductionTypeRepository(RepositoryContext repositoryContext) : base(repositoryContext)
    {
