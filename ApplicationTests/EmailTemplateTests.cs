 ...
 public class EmailTemplateTests : ServiceFixture<IEmailTemplateService>
  {
    ...
    public void Create()
    {
      ...
      var result2 = _emailTemplateService.GetOne(9).Result;
    ...
    public void GetAll()
    {
      ...
      result.Data.Where(x => x.Id == 9).SingleOrDefault().Should().BeEquivalentTo(_emailTemplate1, options => options.Excluding(o => o.UpdatedOn).Excluding(o => o.ConcurrencyStamp).Excluding(o => o.EmailSender).Excluding(o => o.TemplateType));
    }

    [Test, Order(3)]
    public void GetOne()
    {
      var result = _emailTemplateService.GetOne(9).Result;
      Assert.IsNotNull(result);
      Assert.IsNotNull(result.Data);
    ...
    {
      var result = _emailTemplateService.GetDefaultTemplateForType(1, Language.Englisch).Result;
      Assert.IsNotNull(result);
      Assert.IsNotNull(result.Data);
    ...
    public void Update()
    {
      ...
      result.Data.Should().BeEquivalentTo(_emailTemplateService.GetOne(9).Result.Data, options => options.Excluding(o => o.UpdatedOn).Excluding(o => o.ConcurrencyStamp).Excluding(o => o.EmailSender).Excluding(o => o.TemplateType));
    }

    [Test, Order(6)]
    public void Cocurrency()
    {
      var emailTemplate = _emailTemplateService.GetOne(9).Result.Data;
    ...
    public void Test7()
    {
      ...
      Assert.IsTrue(result.IsSuccess);
      var result2 = _emailTemplateService.GetOne(10).Result;
    ...
    public void Test8()
    {
      ...
      Assert.IsTrue(result.IsSuccess);
      var result2 = _emailTemplateService.GetOne(11).Result;
    ...
    public void Test91()
    {
      ...
      var result2 = _emailTemplateService.Update(result.Data).Result;
      Assert.IsTrue(result2.IsSuccess);
      var result3 = _emailTemplateService.GetOne(10).Result;
    ...
    public void Test92()
    {
      var result = _emailTemplateService.Delete(9).Result;
    ...
    public void Test93()
    {
      var result = _emailTemplateService.Delete(10).Result;
      Assert.IsTrue(result.IsSuccess);
    }
  }
}
